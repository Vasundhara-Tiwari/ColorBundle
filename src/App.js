    ...
    <div className="main-page">
      <div className="main-page__header">
        <div className="page-title">
          ...
          <span style={{ color: "#702963" }}>o</span>
          <span style={{ color: "#ffb347" }}>l</span>
          <span style={{ color: "#008080" }}>o</span>
          <span style={{ color: "#36454f" }}>r</span>
          <span> </span>
          <span style={{ color: "#0047ab" }}>B</span>
          <span style={{ color: "#40e0d0" }}>u</span>
          <span style={{ color: "#ff69b4" }}>n</span>
          <span style={{ color: "#e97451" }}>d</span>
          <span style={{ color: "#551a8b" }}>l</span>
          <span style={{ color: "#ff4f00" }}>e</span>
        </div>
      ...
      <div className="shade-division">
        ...
        <br />
        <br />
        <div className="palatte-heading">Pink Shades</div>
        <hr
          style={{
            width: "92.5%",
            height: "0.1vw",
      ...
      <div className="shade-division">
        ...
        <br />
        <br />
        <div className="palatte-heading">Gray Shades</div>
        <hr
          style={{
            width: "92.5%",
            height: "0.1vw",
